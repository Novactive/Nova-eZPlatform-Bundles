...
| [RssFeedBundle](https://github.com/Novactive/NovaeZRssFeedBundle): Get the RSS feed of the selected locations including selected content fields using specified url | ![eZ-Platform-2.x-OK] ![eZ-Platform-3.x-OK] | ![auto-install] |
