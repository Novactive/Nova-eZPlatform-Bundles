...
{
    private const INDEX_FIELD = 'invisible_b';

    public function supports(Criterion $criterion): bool
    {
        return $criterion instanceof Criterion\Visibility && Criterion\Operator::EQ === $criterion->operator;
    }

    public function visit(CriterionVisitor $dispatcher, Criterion $criterion, string $additionalOperators = ''): string
    {
        return $additionalOperators.self::INDEX_FIELD.':'.
               (Criterion\Visibility::HIDDEN === $criterion->value[0] ? 'true' : 'false');
    }
}
