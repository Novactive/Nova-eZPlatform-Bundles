...
namespace AlmaviaCX\Bundle\IbexaOidcBundle\DependencyInjection;
...
class AlmaviaCXIbexaOidcExtension extends Extension implements PrependExtensionInterface
{
    ...
    public function prepend(ContainerBuilder $container)
    {
        $files = [
            ...
            'knpu_oauth2_client' => 'knpu_oauth2_client.yaml',
        ];
