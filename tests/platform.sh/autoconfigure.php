<?php
/**
 * Platform.sh Auto-configure for bundle deploy on fresh Symfony App install
 *
 * @author    Plopix <morel.seb@gmail.com>
 * @copyright 2018 Plopix
 * @license   https://opensource.org/licenses/MIT
 */

$appRootDir = $_SERVER['AUTCONFIGURE_APP_ROOT_DIR'] ?? null;
$bundleDir  = $_SERVER['AUTCONFIGURE_BUNDLE_DIR'] ?? getenv('PLATFORM_DIR') ?? '~';

if (null === $appRootDir) {
    echo "AUTCONFIGURE_APP_ROOT_DIR must be defined.";
}
