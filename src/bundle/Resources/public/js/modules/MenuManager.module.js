(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["MenuManager"] = factory(require("react"), require("prop-types"));
	else
		root["Novactive"] = root["Novactive"] || {}, root["Novactive"]["modules"] = root["Novactive"]["modules"] || {}, root["Novactive"]["modules"]["MenuManager"] = factory(root["React"], root["PropTypes"]);
...
var _treeView = __webpack_require__(6);
...
class MenuManagerModule extends _react.Component {
    constructor(props) {
        super(props);
        this.state = {
            items: [],
    ...
    componentDidMount() {
        ...
        for (let parsedItem of parsedItems) {
            const item = new _menuItem2.default({
                id: parsedItem['id'],
    ...
    render() {
        ...
        if (this.state.editedItem) {
            ...
            editForm = _react2.default.createElement(MENU_MANAGER_EDIT_FORMS_COMPONENTS[editFormType], {
        ...
        return _react2.default.createElement(
            ...
            _react2.default.createElement(
                'div',
                { className: 'col-md-12' },
                _react2.default.createElement(_treeView2.default, { items: this.state.items, onChange: this.handleTreeChange, onEdit: this.handeEdit, language: eZ.adminUiConfig.languages.priority[0], types: this.config.types })
            ),
...
exports.default = MenuManagerModule;
MenuManagerModule.propTypes = {
    loadJson: _propTypes2.default.func,
...
class TreeView extends _react.PureComponent {
    constructor(props) {
        super(props);
        this.tree = null;
    ...
    onTreeChange() {
        ...
        for (const _ref of Object.entries(tree)) {
            ...
            const item = _menuItem2.default.fromTreeNode(node, index);
            items.set(item.id, item);
        }
    ...
    componentDidMount() {
        this.tree = (0, _jquery2.default)(this.treeContainer).jstree({
            core: {
        ...
        (0, _jquery2.default)(this.treeContainer).on('move_node.jstree copy_node.jstree delete_node.jstree create_node.jstree', this.onTreeChange);
    }
    ...
    render() {
        return _react2.default.createElement('div', { ref: div => this.treeContainer = div });
    }
}

exports.default = TreeView;
TreeView.propTypes = {
    items: _propTypes2.default.arrayOf(_propTypes2.default.instanceOf(_menuItem2.default)),
...
var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;/*! jsTree - v3.3.6 - 2018-10-17 - (MIT) */
!function(a){"use strict"; true?!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(2)], __WEBPACK_AMD_DEFINE_FACTORY__ = (a),
...
if(false) {
	module.hot.accept("!!../../../../node_modules/css-loader/index.js!./menu-manager.css", function() {
		var newContent = require("!!../../../../node_modules/css-loader/index.js!./menu-manager.css");
